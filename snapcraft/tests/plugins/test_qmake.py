...
class QMakeTestCase(tests.TestCase):
    ...
    def test_schema(self):
        ...
        self.assertThat(
            options_type, 'array',
            Equals('Expected "options" "type" to be "array", but it '
                   'was "{}"'.format(options_type)))

        options_minitems = options['minitems']
        self.assertThat(
            options_minitems, 1,
            Equals('Expected "options" "minitems" to be 1, but '
        ...
        self.assertThat(
            options_default, [],
            Equals('Expected "options" "default" to be [], but '
        ...
        self.assertThat(
            options_items_type, 'string',
            Equals('Expected "options" "items" "type" to be '
                   '"string", but it was "{}"'
        ...
        self.assertThat(
            qt_version_default, 'qt5',
            Equals('Expected "qt_version" "default" to be "qt5", but '
        ...
        self.assertThat(
            project_files_type, 'array',
            Equals('Expected "project_files" "type" to be "array", but '
                   'it was "{}"'.format(project_files_type)))

        project_files_minitems = project_files['minitems']
        self.assertThat(
            project_files_minitems, 1,
            Equals('Expected "project_files" "minitems" to be 1, but '
        ...
        self.assertThat(
            ...
            Equals('Expected "project_files" "default" to be [], but '
        ...
        self.assertThat(
            project_files_items_type, 'string',
            Equals('Expected "project_files" "items" "type" to be '
                   '"string", but it was "{}"'
    ...
    def assert_expected_environment(self, expected):
        ...
        for call_args in self.run_mock.call_args_list:
            ...
            for variable, value in expected.items():
                ...
                self.assertThat(environment[variable], value,
                                Equals('Expected ${}={}, but it was {}'.format(
