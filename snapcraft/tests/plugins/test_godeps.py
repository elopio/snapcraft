...
class GodepsPluginTestCase(tests.TestCase):
    ...
    def test_schema(self):
        ...
        self.assertThat(
            godeps_file_type, 'string',
            Equals('Expected "godeps-file" "type" to be "string", but '
                   'it was "{}"'.format(godeps_file_type)))

        godeps_file_default = godeps_file['default']
        self.assertThat(
            godeps_file_default, 'dependencies.tsv',
            Equals('Expected "godeps-file" "default" to be '
        ...
        self.assertThat(
            go_importpath_type, 'string',
            Equals('Expected "go-importpath" "type" to be "string", but '
